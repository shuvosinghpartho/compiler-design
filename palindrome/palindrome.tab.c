...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: WORD NEWLINE  */
#line 29 "palindrome.y"
                   {
          if (isPalindrome((yyvsp[-1].str))) {
...
#line 1070 "palindrome.tab.c"
    break;


#line 1074 "palindrome.tab.c"
